...
*Allies  Full Messages to Recruiters :
 <Company Name> is a huge name in both technology and travel, and as a user of <Company Name>, this is one of the companies I would love to work for. I'm a software engineer specializing in web
 development using tech such as React, Javascript, and Node, all of which align with the skills posted in this job post for
 Software Development Engineer II: https://www.linkedin.com/jobs/view/2904408122

If you have the time, I would appreciate you checking out my portfolio, and if you don't (or are not the right person to be reaching out to)
I would be so grateful if you could redirect me or my message to the appropriate person.
...
* Message #2
Hello <Name>! <COMP-NAME> was recently highlighted as a growing company from an App Academy event, and I was hoping to connect regarding <COMP-NAME> <POSITION> opening.
As an App Academy graduate we share a lot of the skills you're looking for and would love to chat more about my candidacy.


* Recruiter Connection Message limited to 300 chars
Don't know you personally YET but early career SWE here, shares the values of Expedia, and fits the SDE II role pretty strongly. Would love to connect,
but if not thanks for your time. Best, Allie

* Message #2
Hello <Name>! I'm a software engineer specializing in web
 development using tech such as <Tech from job description> all of which align with the skills posted in this job post for
 <Postion Title>: https://www.linkedin.com/jobs/view/2904408122 . Would love to have a quick 15 minutue chat about the opportunity, how does next monday at 1pm PST sound?

* Message #3
Hi <name>! I don't know you personally YET but early career SWE here who fits the <Postion Title> role pretty strongly that's
listed here : <link>. Would love to connect, but if not thank you for your time.
